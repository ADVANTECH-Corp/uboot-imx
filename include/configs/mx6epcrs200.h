...
#if defined(CONFIG_TARGET_MX6QEPCRS200A1_512M) || defined(CONFIG_TARGET_MX6QEPCRS200A2_512M)
#define PHYS_SDRAM_SIZE         (512u * 1024 * 1024)
#elif defined(CONFIG_TARGET_MX6QEPCRS200A1_1G) || defined(CONFIG_TARGET_MX6QEPCRS200A2_1G)
#define PHYS_SDRAM_SIZE         (1u * 1024 * 1024 * 1024)
#elif defined(CONFIG_TARGET_MX6QEPCRS200A1_2G) || defined(CONFIG_TARGET_MX6QEPCRS200A2_2G)
#define PHYS_SDRAM_SIZE         (2u * 1024 * 1024 * 1024)
#endif

#if defined(CONFIG_TARGET_MX6QEPCRS200A1_1G) || defined(CONFIG_TARGET_MX6QEPCRS200A1_2G)
...
#define CONFIG_DEFAULT_FDT_FILE	"imx6dl-epcrs200-a1.dtb"
#endif
#elif defined(CONFIG_TARGET_MX6QEPCRS200A2_1G)
#if defined(CONFIG_MX6QP)
