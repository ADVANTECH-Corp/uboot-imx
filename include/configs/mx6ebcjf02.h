...
#define IOMUX_PCIE_RESET        MX6_PAD_SD1_DAT0__GPIO1_IO16   //LTE_SW_RESET
#define PCIE_RESET              IMX_GPIO_NR(1,16)

#define CONFIG_M2_SLOT
#define IOMUX_M2E_SW_RESET	MX6_PAD_SD3_CLK__GPIO7_IO03    //M.2E_SW_RESET
#define M2E_SW_RESET		IMX_GPIO_NR(7, 3)
