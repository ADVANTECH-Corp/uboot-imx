...
#include <rtl8367/dal/rtl8367c/rtl8367c_smi.h>
#include <rtl8367/rtk_error.h>
#include <rtl8367/api_sys.h>

void adv_dm_gpio_set_dir_flags(unsigned gpio,rtk_uint32 direction);
void adv_dm_gpio_get_value(unsigned gpio,rtk_uint32 *pData);
void adv_dm_gpio_set_value(unsigned gpio,rtk_uint32 Data);
...
unsigned  smi_SCK;    /* GPIO used for SMI Clock Generation */
unsigned  smi_SDA;    /* GPIO used for SMI Data signal */

/* I2C, redefine/implement the following Macro */
#define GPIO_DIRECTION_SET(gpioID, direction)	adv_dm_gpio_set_dir_flags(gpioID, direction)
#define GPIO_DATA_SET(gpioID, data)   			adv_dm_gpio_set_value(gpioID, data)
#define GPIO_DATA_GET(gpioID, pData)  			adv_dm_gpio_get_value(gpioID,pData)
